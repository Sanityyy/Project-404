...
function preload() {
	backgroundmirage = loadImage("./Pictures/background.PNG");
	player = loadImage("./Pictures/player.PNG");
	global = loadImage("./Pictures/globalelite.PNG");
	silver = loadImage("./Pictures/silver.PNG");
